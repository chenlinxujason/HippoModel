...
#ifdef __NO_CUDA__
   int CA3_QuadD_LM = sim.createGroup("CA3_QuadD_LM", 3280.0, //3280.0,
                              INHIBITORY_NEURON, 0, CPU_CORES);
                              
   int CA3_Axo_Axonic = sim.createGroup("CA3_Axo_Axonic", 1909.0,//1909.0,
                              INHIBITORY_NEURON, 0, CPU_CORES);
                              
   int CA3_Basket = sim.createGroup("CA3_Basket", 515.0,//515.0,
                              INHIBITORY_NEURON, 0, CPU_CORES);
                              
   int CA3_BC_CCK = sim.createGroup("CA3_BC_CCK", 665.0,//665.0,
                              INHIBITORY_NEURON, 0, CPU_CORES);
                              
   int CA3_Bistratified = sim.createGroup("CA3_Bistratified", 4631.0,//4631.0,
                              INHIBITORY_NEURON, 0, CPU_CORES);
                              
   int CA3_Ivy = sim.createGroup("CA3_Ivy", 2334.0,//2334.0,
                              INHIBITORY_NEURON, 0, CPU_CORES);
                              
   int CA3_MFA_ORDEN = sim.createGroup("CA3_MFA_ORDEN", 1526.0,//1526.0,
                              INHIBITORY_NEURON, 0, CPU_CORES);
                              
   int CA3_Pyramidal = sim.createGroup("CA3_Pyramidal", 74366.0,//74366.0,
                              EXCITATORY_NEURON, 0, CPU_CORES);
                              
   int DG_Granule = sim.createSpikeGeneratorGroup("DG_Granule", 10, EXCITATORY_NEURON, 0, CPU_CORES);
   ...
   int DG_Granule = sim.createSpikeGeneratorGroup("DG_Granule", 10, EXCITATORY_NEURON, 0, GPU_CORES);                         
#endif
   
SpikeGeneratorFromFile SGF("results/MECCells_Spike.dat");
// associate group g0 with SGF
sim.setSpikeGenerator(DG_Granule, &SGF);
...
// connect CA3 to spike generator - DG or EC
