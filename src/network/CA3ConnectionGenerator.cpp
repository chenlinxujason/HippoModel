...
CA3ConnectionGenerator::CA3ConnectionGenerator(
...
std::pair<float, float> CA3ConnectionGenerator::getCoords(const std::string& group, int global_id) const {
...
void CA3ConnectionGenerator::connect(CARLsim* sim, int srcGrp, int i, int destGrp, int j,
