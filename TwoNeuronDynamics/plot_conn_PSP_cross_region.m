...
%% CA3 Local - Initial
Connection_types = {
    'MEC-CA3PC', 382, -58.63, -42.74, 0.98, 38.55, 0.008, 12.49, -34.52, 138,   0.482, 36.2, 47.0, 1.0, 0.68;
    'LEC-CA3PC', 382, -58.63, -42.74, 0.98, 38.55, 0.008, 12.49, -34.52, 138,   0.482, 36.2, 47.0, 1.0, 0.68;
    'DGGC-CA3PC', 382, -58.63, -42.74, 0.98, 38.55, 0.008, 12.49, -34.52, 138,  1.543, 36.2, 47.0, 1.0, 0.68;
    'MEC-CA3BC', 45, -57.51, -23.38, 1.0, 18.45, 0.004, 9.26, -47.56, -6.0,     1.343, 38.0, 89.4, 1.0, 0.686;
    'LEC-CA3BC', 45, -57.51, -23.38, 1.0, 18.45, 0.004, 9.26, -47.56, -6.0,     1.343, 38.0, 89.4, 1.0, 0.686;
    'DGGC-CA3BC', 45, -57.51, -23.38, 1.0, 18.45, 0.004, 9.26, -47.56, -6.0,    1.698, 38.0, 89.4, 1.0, 0.686;
    };


%% CA3 Local - Fine tune
% Connection_types = {
%     'MEC-CA3PC', 382, -58.63, -42.74, 0.98, 38.55, 0.008, 12.49, -34.52, 138,   0.7, 36.2, 47.0, 1.0, 0.68;
%     'LEC-CA3PC', 382, -58.63, -42.74, 0.98, 38.55, 0.008, 12.49, -34.52, 138,   0.7, 36.2, 47.0, 1.0, 0.68;
%     'DGGC-CA3PC', 382, -58.63, -42.74, 0.98, 38.55, 0.008, 12.49, -34.52, 138,   2.0, 36.2, 47.0, 1.0, 0.68;
%     'MEC-CA3BC', 45, -57.51, -23.38, 1.0, 18.45, 0.004, 9.26, -47.56, -6.0,     0.59, 38.0, 89.4, 1.0, 0.686;
%     'LEC-CA3BC', 45, -57.51, -23.38, 1.0, 18.45, 0.004, 9.26, -47.56, -6.0,     0.59, 38.0, 89.4, 1.0, 0.686;
%     'DGGC-CA3BC', 45, -57.51, -23.38, 1.0, 18.45, 0.004, 9.26, -47.56, -6.0,     2.2, 38.0, 89.4, 1.0, 0.686;
%     };
...
for i = 1:num_connections
    ...
    xlim([80, 280]); 
    ylim([min(v2)-0.1, max(v2)+0.1]);%0.5
